...
_PUSHTASKRESRESPONSE_RESULTSENTRY = _PUSHTASKRESRESPONSE.nested_types_by_name[
    "ResultsEntry"
]
_RECONNECT = DESCRIPTOR.message_types_by_name["Reconnect"]
PullTaskInsRequest = _reflection.GeneratedProtocolMessageType(
    "PullTaskInsRequest",
    (_message.Message,),
    {
...
PullTaskInsResponse = _reflection.GeneratedProtocolMessageType(
    "PullTaskInsResponse",
    (_message.Message,),
    {
...
PushTaskResRequest = _reflection.GeneratedProtocolMessageType(
    "PushTaskResRequest",
    (_message.Message,),
    {
...
PushTaskResResponse = _reflection.GeneratedProtocolMessageType(
    "PushTaskResResponse",
    (_message.Message,),
    {
...
Reconnect = _reflection.GeneratedProtocolMessageType(
    "Reconnect",
    (_message.Message,),
    {
